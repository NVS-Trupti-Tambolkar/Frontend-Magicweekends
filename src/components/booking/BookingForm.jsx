...
const BookingForm = ({ isOpen, onClose, tripData, tripType, initialTravelerCount = 1 }) => {
    const { user } = useAuth();
    ...
    const [formData, setFormData] = useState({
        ...
        phone: '',
        travel_date: '',
        number_of_people: initialTravelerCount,
        payment_method: '',
        special_request: '',
    ...
    }, [isOpen, tripData, user, initialTravelerCount]);
