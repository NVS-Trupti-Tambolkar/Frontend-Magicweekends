...
const WeekendTrips = ({ onLoad }) => {
    ...
    const handleBrochureUpload = (e) => {
        ...
        if (file) {
            ...
            setNewTrip(prev => ({ ...prev, brochure: file }));
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            formData.append('inclusions', JSON.stringify(newTrip.inclusions.split(',').map(s => s.trim()).filter(s => s !== "")));
            formData.append('exclusions', JSON.stringify(newTrip.exclusions.split(',').map(s => s.trim()).filter(s => s !== "")));
            ...
            if (newTrip.brochure) {
                formData.append('brochure', newTrip.brochure);
            }
                                                    ...
                                                    {trip.brochure_url && (
                                                        <button
                                                            onClick={(e) => {
                                                                ...
                                                                const downloadUrl = `${apiUrl}/WeekendTrip/download-brochure/${trip.id}`;
